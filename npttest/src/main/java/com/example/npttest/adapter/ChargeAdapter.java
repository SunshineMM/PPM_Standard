...
public class ChargeAdapter extends BaseQuickAdapter<Charge,BaseViewHolder>{
    ...
    protected void convert(BaseViewHolder helper, Charge item) {
        ...
        helper.setText(R.id.item_car_type,"收费金额："+srmon+"元");
        helper.setText(R.id.item_card_type,"入场时间："+DateTools.getDate(itime*1000));
        helper.setText(R.id.item_carin_time, "出场时间："+DateTools.getDate(ctime*1000));
        // 加载网络图片
