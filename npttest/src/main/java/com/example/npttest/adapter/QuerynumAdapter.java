...
public class QuerynumAdapter extends BaseQuickAdapter<Querynum,BaseViewHolder> {

    private String cartype,pztype;
    public QuerynumAdapter(@Nullable List<Querynum> data) {
        super(R.layout.presenceitem,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Querynum item) {
